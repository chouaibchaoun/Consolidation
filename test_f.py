...
os.chdir('C:/Users/choua/OneDrive/Documents/udemy/Inex')
...
s1 = pd.read_csv('source_1.csv' , encoding = "utf8" , delimiter = ';')
s2 = pd.read_csv('source_2.csv' , encoding = "ISO-8859-1" , delimiter = ';')
s3 = pd.read_csv('source_3.csv' , encoding = "ISO-8859-1" , delimiter = ';')

# # # Supression des colonnes nulles
# 
# s3.dropna(axis = 1, how = "all" , inplace = True)
