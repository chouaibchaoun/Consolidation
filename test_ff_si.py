...
os.chdir('C:/Users/choua/OneDrive/Documents/Inex')
...
s1 = pd.read_csv('source_1.csv' , encoding = "ISO-8859-1" , delimiter = ';')
s2 = pd.read_csv('source_2.csv', encoding = "ISO-8859-1" , delimiter = ';')
s3 = pd.read_csv('source_3.csv' , encoding = "ISO-8859-1" , delimiter = ';')
...
while b == True :
    ...
    if R.lower() == "oui" :
        filepath4 = input('Entrer le path de la source 4 avec le nom du fichier :')
...
ss.to_csv("source_finale.csv" , encoding = 'ISO-8859-1' , sep = ';',na_rep = 'nan',columns = list(ss.columns))
